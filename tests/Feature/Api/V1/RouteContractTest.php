...
test('every approved v1 route is present exactly once', function () {
    ...
    $expected = [
        ...
        'GET|HEAD api/v1/accessories',
        'GET|HEAD api/v1/accessories/{accessory}',
        'GET|HEAD api/v1/accessories/{accessory}/reviews',
        'GET|HEAD api/v1/accessories/{accessory}/reviews/attachments/{attachment}',
        'GET|HEAD api/v1/accessory-order-requests',
        'GET|HEAD api/v1/accessory-order-requests/{accessoryOrderRequest}',
        ...
        'GET|HEAD api/v1/frames/{frame}/reviews',
        'GET|HEAD api/v1/frames/{frame}/reviews/attachments/{attachment}',
        'GET|HEAD api/v1/me',
        ...
        'POST api/v1/accessory-order-requests/{accessoryOrderRequest}/cancel',
        'POST api/v1/accessory-order-requests/{accessoryOrderRequest}/discount-proof',
        ...
        'POST api/v1/optical-orders/{jobOrder}/payment-proof',
