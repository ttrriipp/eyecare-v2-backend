...
final class SaveEyewearSpecification
{
    ...
    private function validate(array $data): array
    {
        $validator = Validator::make($data, [
            ...
            'lens_design_snapshot' => ['sometimes', 'nullable', 'string', 'max:255'],
            ...
            'distance_pd_mode' => ['sometimes', 'string', 'in:binocular,monocular'],
            'distance_pd_binocular' => ['sometimes', 'nullable', 'numeric', 'min:40', 'max:90'],
            'distance_pd_od' => ['sometimes', 'nullable', 'numeric', 'min:20', 'max:45'],
            'distance_pd_os' => ['sometimes', 'nullable', 'numeric', 'min:20', 'max:45'],
