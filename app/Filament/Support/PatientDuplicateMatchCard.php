...
class PatientDuplicateMatchCard
{
    ...
    public static function render(Collection $matches, string $emptyMessage = ''): HtmlString
    {
        ...
        return new HtmlString(
            '<div class="rounded-lg border border-warning-200 bg-warning-50 dark:border-warning-500/20 dark:bg-warning-500/10">'
            .'<div class="flex items-center gap-x-2 px-3 py-2 text-sm font-medium text-warning-700 dark:text-warning-400">'
            ...
            .'</div>'
            .'<div class="border-t border-warning-200 dark:border-warning-500/20"></div>'
            .$rows
            .'</div>'
        );
    }
