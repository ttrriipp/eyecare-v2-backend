...
- [ ] Core UI contains no user-facing Encounter wording.
- [ ] Internal routes, filters, and domain symbols are unchanged.
...
- [ ] Related screens and print output use Consultation consistently.
- [ ] No machine-readable source or route contract changed.
...
- [ ] User-readable error copy uses Consultation consistently.
- [ ] State machines and audit values remain unchanged.

## Phase 4: Regression Guard and Reconciliation

- [ ] Task 14: Add targeted terminology guard and reconcile context
...
- [ ] Focused test suite passes after Pint.
- [ ] Presentation scan finds no residual user-facing Encounter or Consulation.
- [ ] Android-native wording is recorded as a separate repository follow-up.
